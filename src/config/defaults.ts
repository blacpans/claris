...
export const DEFAULT_STYLES = {
  ...
  passion: [
    ...
    '.txt', // Documentation
    '.vue',
    '.svelte', // Frontend Frameworks (often requires creativity)
    '.astro',
  ],
} as const;
 ...
 */
export const DEFAULT_IGNORED_FILES = ['package-lock.json', 'yarn.lock', 'pnpm-lock.yaml', 'bun.lockb'] as const;
