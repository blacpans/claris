...
export async function createEventFn({ summary, startDateTime, endDateTime, description }: { summary: string, startDateTime: string, endDateTime: string, description?: string }) {
  const calendar = await getCalendarClient();
